...
\end{align*}
so $\ropt \geq 0$.
Using \eqref{eq:18}, we have $$\left\langle \mu _ { p } - g _ { i -1} , \mu _ { p } - \overline { g _ { i } } \right\rangle _ { \mathscr { H } } \leq 0.$$
Thus
\begin{align*}
...
where $q^2 = ???$
 ...
 \begin{boxcomputation}
Using $g _ { i } = \left( 1 - \ropt \right) g _ { i - 1 } + \ropt \overline { g } _ { i }$ and the fact that $J$ is equal to its quadratic approximation, we have :
\begin{align*}
  \norme{\mu_p-g_i}^2
